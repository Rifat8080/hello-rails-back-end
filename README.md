...
- [Front end Link](https://github.com/Rifat8080/hello-react-front-end)
...
```bash
  git clone https://github.com/Rifat8080/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/Rifat8080/hello-rails-back-end/issues).
